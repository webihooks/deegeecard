                            ...
                            <div class="discount-card">
                                ...
                                <div class="msg">
                                    ...
                                    <?php if (!empty($discount['discount_in_flat'])): ?>
                                        ₹<?php echo htmlspecialchars(number_format($discount['discount_in_flat'], 0)); ?> OFF
                                    <?php endif; ?>

                                    on orders over ₹<?php echo htmlspecialchars(number_format($discount['min_cart_value'], 0, '.', '')); ?>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
