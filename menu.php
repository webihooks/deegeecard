        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="profile-cover-photo.php">
                    ...
                    <span class="nav-text">Profile & Cover Photo</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="bank-details.php">
                    <span class="nav-icon">
            ...
            <li class="nav-item">
                <a class="nav-link" href="qr-code-details.php">
                    ...
                    <span class="nav-text">QR Code Details</span>
                </a>
            </li>
            ...
            <li class="menu-title">My Customers</li>
