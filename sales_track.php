                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <div class="row mt-3">
                                                                <div class="col-md-6 mb-2">
                                                                    ...
                                                                    <input type="text" class="form-control" name="street" id="street" value="<?= htmlspecialchars($_POST['street'] ?? '') ?>" readonly>
                                                                </div>
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        <?php if (!empty($sales_track_list)): ?>
                                                            <?php foreach ($sales_track_list as $entry): ?>
                                                                <tr>
                                                        ...
                                                        <?php else: ?>
                                                            <tr>
                                                                <td colspan="<?= ($role === 'admin') ? '15' : '14' ?>" class="text-center">No records found</td>
                                                            </tr>
                                                        <?php endif; ?>
                                                    </tbody>
                                                </table>
